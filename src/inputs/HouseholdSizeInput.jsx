  ...
  return (
    <div className="input input-household-size">
      ...
      <div className="radio-buttons">
        ...
        <input type="number" name="household-size" id="household-size-input" className="household-size-input" value={householdSize} onChange={e => setHouseholdSize(e.target.value)} />
