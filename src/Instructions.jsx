...
export const Instructions = () => (
  <div className="instructions">
    ...
    <p>
      ...
      Statistics' <a href="https://www.ons.gov.uk/peoplepopulationandcommunity/healthandsocialcare/conditionsanddiseases/bulletins/coronaviruscovid19infectionsurveypilot/8january2021">Coronavirus Infection Survey</a> and
    ...
    <p>
      All the information you enter will be kept on your device, although we use analytics and cookies to
      measure how many people are using this site.
    </p>
    <LinkGrid />
    <p className="cta">Click the button below to start.</p>
  </div>
);
